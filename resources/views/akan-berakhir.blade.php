...
<h4>Data Kerjasama Akan Berakhir</h4>
</div>
      <div class="box-body"> 
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody><?php $a=1;?>
        @foreach($akanberakhir as $key => $dt)
        <tr>
         ...
         <td class="text-center">{{$dt->pengelola}}</td>
          ...
          <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;" id="edit_modal{{$dt->id}}">
...
@else
<a class="btn btn-info" href="{{ url('/download/'.$dt->id) }}"> <i class="fa fa-download"> Download </i></a>
@endif
              </div>
            </div>
            <!-- /.modal-content -->
